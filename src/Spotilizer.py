...
button1 = Button(topFrame, padx=10, pady=10, highlightbackground="#ffffff", relief=RAISED, highlightthickness=0, bd=0, cursor="hand", text="Previous", command=lambda:[previous(), albumDisplayUpdate()]) #Positioning Button as (<FrameName>,<Text to Appear>,<Text Color>)
button1.pack(side=LEFT,padx=50,pady=20)
button2 = Button(topFrame, padx=10, pady=10, highlightbackground="#ffffff", relief=RAISED, highlightthickness=0, bd=0, cursor="hand", text="Play", command=lambda:[play(), albumDisplayUpdate()])
...
button3 = Button(topFrame, padx=10, pady=10, highlightbackground="#ffffff", relief=RAISED, highlightthickness=0, bd=0, cursor="hand", text="Pause", command=lambda:[pause(), albumDisplayUpdate()])
button3.pack(side=LEFT,padx=50,pady=20)
button4 = Button(topFrame, padx=10, pady=10, highlightbackground="#ffffff", relief=RAISED, highlightthickness=0, bd=0, cursor="hand", text="Forward", command=lambda:[forward(), albumDisplayUpdate()])
